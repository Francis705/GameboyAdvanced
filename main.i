...
# 22 "Witch.h"
extern const unsigned short WitchTiles[8480];


extern const unsigned short WitchMap[1024];
...
# 33 "main.c" 2
# 1 "purpleHalloween.h" 1
# 22 "purpleHalloween.h"
extern const unsigned short purpleHalloweenTiles[16480];


extern const unsigned short purpleHalloweenMap[1024];


extern const unsigned short purpleHalloweenPal[256];
# 34 "main.c" 2
# 1 "PumpkinLose.h" 1
# 22 "PumpkinLose.h"
extern const unsigned short PumpkinLoseTiles[2288];


extern const unsigned short PumpkinLoseMap[1024];


extern const unsigned short PumpkinLosePal[16];
# 35 "main.c" 2
# 1 "PumpkinWin.h" 1
# 22 "PumpkinWin.h"
extern const unsigned short PumpkinWinTiles[10736];


extern const unsigned short PumpkinWinMap[1024];


extern const unsigned short PumpkinWinPal[16];
# 36 "main.c" 2
# 1 "PumpkinInstruction.h" 1
# 22 "PumpkinInstruction.h"
extern const unsigned short PumpkinInstructionTiles[2608];


extern const unsigned short PumpkinInstructionMap[1024];


extern const unsigned short PumpkinInstructionPal[16];
# 37 "main.c" 2
# 1 "sound.h" 1
SOUND soundA;
SOUND soundB;
...
extern const signed char zombiePanic[1947168];
# 39 "main.c" 2
# 1 "Ouch.h" 1
...
extern const signed char ouch[21312];
# 40 "main.c" 2
...
void initialize() {
    ...
    (*(volatile unsigned short*)0x4000008) = ((0)<<2)| ((28)<<8) | (0<<7);
...
void goToStart() {
    ...
    (*(volatile unsigned short*)0x4000008) = ((1)<<2)| ((5)<<8) | (0<<7);



    DMANow(3,PumpkinPal, ((unsigned short *)0x5000000), 32/2);
    DMANow(3,PumpkinTiles,&((charblock *)0x6000000)[1],4448 / 2);
    DMANow(3,PumpkinMap,&((screenblock *)0x6000000)[5],2048 / 2);
        hideSprites();
        waitForVBlank();
...
void start() {
  ...
  stopSound();
  playSoundA(zombiePanic,1947168,1);
...
void goToGame() {
    ...
    DMANow(3,shadowOAM,((OBJ_ATTR*)(0x7000000)),512);
    (*(volatile unsigned short*)0x4000008) = ((0)<<2)| ((17)<<8) | (1<<7) | (1<<14);
    (*(volatile unsigned short*)0x400000A) = ((3)<<2)| ((31)<<8) | (0<<7) | (0<<14);
    if (heartCounter == 1){
        goToLose();
    }
    ...
    DMANow(3,neigborhoodPal, ((unsigned short *)0x5000000), 64/2);
    DMANow(3,MoonSkyTiles, &((charblock *)0x6000000)[3],1536 / 2);
    DMANow(3,MoonSkyMap, &((screenblock *)0x6000000)[31],2048/ 2);



    DMANow(3,neigborhoodPal, ((unsigned short *)0x5000000),64/2);
    DMANow(3,neigborhoodTiles, &((charblock *)0x6000000)[0],33792 / 2);
    DMANow(3,neigborhoodMap, &((screenblock *)0x6000000)[17],4096/ 2);
...
void goToWin() {
    (*(unsigned short *)0x4000000) = 0 | (1<<8) | (1<<12);
    (*(volatile unsigned short*)0x4000008) = ((0)<<2)| ((11)<<8) | (0<<7) | (0<<14);
    DMANow(3,shadowOAM,((OBJ_ATTR*)(0x7000000)),512);
    hideSprites();
    DMANow(3,WitchPal,((unsigned short *)0x5000000),32/2);
    DMANow(3,WitchTiles,&((charblock *)0x6000000)[0],16960 / 2);
    DMANow(3,WitchMap,&((screenblock *)0x6000000)[11],2048 / 2);
    hideSprites();
    waitForVBlank();
    DMANow(3,shadowOAM,((OBJ_ATTR*)(0x7000000)),512);
...
void goToLose() {
    ...
    (*(volatile unsigned short *)0x04000010) =40;
    (*(volatile unsigned short *)0x04000012) =0;
    DMANow(3,LoseScreenPal,((unsigned short *)0x5000000),32/2);
    DMANow(3,LoseScreenTiles,&((charblock *)0x6000000)[0],7168 / 2);
    DMANow(3,LoseScreenMap,&((screenblock *)0x6000000)[20],4096 / 2);
    hideSprites();
    waitForVBlank();
...
void goToInstructions(){
    (*(volatile unsigned short*)0x4000008) = ((0)<<2)| ((11)<<8) | (0<<7) | (0<<14);
    (*(volatile unsigned short *)0x04000010) =0;
    (*(volatile unsigned short *)0x04000012) =45;



    DMANow(3,PumpkinWinPal,((unsigned short *)0x5000000),32/2);
    DMANow(3,PumpkinWinTiles,&((charblock *)0x6000000)[0],21472 / 2);
    DMANow(3,PumpkinWinMap,&((screenblock *)0x6000000)[11],2048 / 2);
